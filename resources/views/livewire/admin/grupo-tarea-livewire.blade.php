<div class="p-6">
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-xl w-full  p-6 relative">
            ...
            <div class="mb-3">
                <div class="overflow-x-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3 ml-3">
                        ...
                        <flux:select wire:model.live="filtroEmpleado">
                            ...
                            @foreach ($tareasEmpleados as $empleado)
    ...
    @if ($deleteMode)
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow-xl w-full max-w-2xl p-6 relative">
            <h2 class="text-xl font-bold mb-4 text-zinc-800 dark:text-zinc-100">{{ __('Confirm Task Deletion') }}
            </h2>
